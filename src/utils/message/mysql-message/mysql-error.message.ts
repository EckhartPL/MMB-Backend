...
export const mySqlErrorMessage = {
  ...
  ER_UNSUPPORTED_EXTENSION:
    'Table uses an extension that does not exist in this MySQL version.',
...
export const getMysqlErrorMessage = (code: string): string => {
  const errorMessagesMap: Record<string, string> = {
    ...
    [MysqlErrorCodes.ER_LOCK_WAIT_TIMEOUT]:
      mySqlErrorMessage.ER_LOCK_WAIT_TIMEOUT,
    [MysqlErrorCodes.ER_NO_REFERENCED_ROW]:
      mySqlErrorMessage.ER_NO_REFERENCED_ROW,
    [MysqlErrorCodes.ER_QUERY_INTERRUPTED]:
      mySqlErrorMessage.ER_QUERY_INTERRUPTED,
    [MysqlErrorCodes.ER_ROW_IS_REFERENCED]:
      mySqlErrorMessage.ER_ROW_IS_REFERENCED,
    [MysqlErrorCodes.ER_SYNTAX_ERROR]: mySqlErrorMessage.ER_SYNTAX_ERROR,
    [MysqlErrorCodes.ER_UNSUPPORTED_EXTENSION]:
      mySqlErrorMessage.ER_UNSUPPORTED_EXTENSION,
    [MysqlErrorCodes.ER_WRONG_VALUE_COUNT]:
      mySqlErrorMessage.ER_WRONG_VALUE_COUNT,
  };
